...
<div class="wrapper">
    <header class="main-header">
        <a class="logo">
            ...
            <span class="logo-lg">MartinSchool
                   {{--<img src="{{ asset('AdminLTE/dist/img/LOGO_JOSE_MARTI.jpg')}}" class="user-image" alt="User Image"  style="width: 20%"/>--}}
                </span>
        </a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>{{Auth::user()->personal()->get()[0]["primerNombre"]}} {{Auth::user()->personal()->get()[0]["primerApellido"]}}
                                    ...
                                    {{--{{strtoupper(Auth::user()->name)}} - {{strtoupper(Auth::user()->getRolUser(Auth::user()->rol_id))}}--}}
